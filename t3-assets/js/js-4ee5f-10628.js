...
var table;jQuery(function($){table=new Tabulator("#example-table",{height:205,data:tabledata,layout:"fitColumns",columns:[{title:"Name",field:"name",width:150},],});$('.image-map').imageMapResize();})
