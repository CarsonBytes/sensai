...
$('#image-map area').click(function(e){e.preventDefault();var $row=$(this).data('row');table.scrollToRow($row,'top',true);table.selectRow($row).delay(200).deselectRow($row).delay(200).selectRow($row).delay(200).deselectRow($row).delay(200).selectRow($row);$("html, body").animate({scrollTop:$("#example-table").offset().top},500);return false;});})
