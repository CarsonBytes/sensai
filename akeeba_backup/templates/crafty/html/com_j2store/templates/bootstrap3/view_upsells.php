	...
	<div class="col-sm-12">
		<h3><?php echo JText::_('J2STORE_RELATED_PRODUCTS_UPSELLS'); ?></h3>
				<?php foreach($this->up_sells as $upsell_product):?>
					...
					<?php endif;?>
					<div class="col-sm-<?php echo round((12 / $columns));?> upsell-item">
					<div class="pro-icon">
						...
						<div class="mod_pic">
							<a href="<?php echo $upsell_product->thumb_image;?>" class="modal" style="display:inline; position:relative;">
						...
						<?php if(count($upsell_product->options) || $upsell_product->product_type == 'variable'): ?>
							<a class="<?php echo $this->params->get('choosebtn_class', 'btn btn-success'); ?>"
								...
								<i class="fa fa-list-alt" title="View Option"></i> <?php echo JText::_('J2STORE_CART_CHOOSE_OPTIONS'); ?>
							</a>
						<?php else: ?>
						<?php
							$this->singleton_product = $upsell_product;
